  ...
  return (
    <>
      ...
      <section className="min-h-screen font-neohel py-2">
        ...
        <p className="text-center font-mono">
          Η πλάκα καστανιάς είναι γνωστή για την εξαιρετική της ποιότητα και το
          πλούσιο χρώμα της. Χρησιμοποιείται ευρέως στην κατασκευή επίπλων και
          διακοσμητικών αντικειμένων, προσφέροντας ένα φυσικό και ζεστό
          αισθητικό αποτέλεσμα. Η αντοχή της στη φθορά και την υγρασία την
          καθιστούν ιδανική επιλογή για διάφορες εφαρμογές, ενώ η ευκολία
          επεξεργασίας της την καθιστά δημοφιλή μεταξύ των κατασκευαστών.
        </p>
      ...
      >
        ...
        <p className="text-center font-mono">
          Οι τάβλες (σανίδια) καστανιάς αποτελούν μία εντυπωσιακή και διαχρονική
          επιλογή στην ξυλεία. Διακρίνονται για την κομψότητα, την ανθεκτικότητα
          και την άριστη ποιότητα τους. Χρησιμοποιούνται ευρέως σε δάπεδα,
          επίπλωση και αρχιτεκτονικές λεπτομέρειες, προσθέτοντας μια φυσική και
          ρουστίκ αισθητική στο χώρο.
        </p>
        <div className="flex md:flex-row flex-col md:gap-20 md:justify-center gap-5 flex-wrap mt-8 md:ml-3">
          <Image
            src="/pics/1.jpg"
